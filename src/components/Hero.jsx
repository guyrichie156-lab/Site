...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden pt-24">
      ...
      <div
        ref={videoRef}
        className="relative z-10 aspect-video h-[min(44vh,405px)] w-auto max-w-[min(72vw,720px)] overflow-hidden rounded-[18px] border border-ink/15 bg-ink/5 shadow-[0_30px_90px_-40px_rgba(0,0,0,0.9)]"
      >
        <video
      ...
      {/* бегущая строка обычным потоком под подписью; направление зависит
          от стороны курсора относительно видео (anchorRef) */}
      <div className="pointer-events-none mt-8 w-full">
